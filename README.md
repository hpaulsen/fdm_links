...
These joints are specially designed for FDM printing.

* No reliance on layer lines for stability.
* No angles greater than 45 degrees.

These are the two biggest problems with flexible/articulated models commonly available. Because these new joints do not rely on layer line strength,
...
1. Create a model
2. Add a joint
3. Add a Boolean difference modifier on the model with the joint as the Object
...
* Only 0.4 mm nozzle diameters are supported (To use other sizes of nozzles, the model and joints should be scaled accordingly.)
